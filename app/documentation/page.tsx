...
export default function UserGuide() {
    ...
    return (
        <div className="min-h-screen bg-black">
            {/* Header */}
            <section className="py-12 sm:py-16 lg:py-20 wave-background border-b border-gray-800">
            ...
            {/* Mobile Menu Button */}
            <div className="lg:hidden sticky top-20 z-40 bg-black border-b border-gray-800">
                <div className="container mx-auto px-4 py-3">
                    <button
                        onClick={() => setSidebarOpen(!sidebarOpen)}
                        className="flex items-center justify-between w-full px-4 py-2 bg-gray-900 border border-gray-800 rounded-lg text-white"
                    >
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
                    ...
                    <aside className={`lg:w-64 shrink-0 ${sidebarOpen ? 'block' : 'hidden lg:block'}`}>
                        <div className="lg:sticky lg:top-24 bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6">
                            <h3 className="text-xs sm:text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3 sm:mb-4">Contents</h3>
                            <nav className="space-y-1">
                                {sections.map((item) => (
                                    <button
                                        key={item.id}
                                        onClick={() => scrollToSection(item.id)}
                                        className={`block w-full text-left px-3 py-2 rounded-lg transition-colors text-xs sm:text-sm ${activeSection === item.id
                    ...
                    <main className="flex-1 max-w-4xl">
                        ...
                        <section id="introduction" className="mb-12 sm:mb-16 scroll-mt-24">
                            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4 sm:mb-6 border-b border-gray-800 pb-3">Introduction</h2>

                            <div className="space-y-4 sm:space-y-6">
                                <div>
                                    <h3 className="text-xl sm:text-2xl font-semibold text-white mb-3 sm:mb-4">What is Linker?</h3>
                                ...
                                <div>
                                    <h3 className="text-xl sm:text-2xl font-semibold text-white mb-3 sm:mb-4">Why Use Linker?</h3>
    ...
    "**/coverage/**"
                        ...
                        <section id="faq" className="mb-16 scroll-mt-24">
                            ...
                            <div className="space-y-6">
                                ...
                                {/* Support */}
                                <div className="border-l-4 border-orange-500 pl-6 py-6 bg-gray-900/50 rounded-r-lg">
                                    <h3 className="text-xl font-semibold text-white mb-6">Need More Help?</h3>
                                    <a
                                        href="https://discord.gg/your-discord-server"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center gap-3 px-6 py-3 bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
                                    >
